...
describe('Chat Triggers - Turn Taking Mechanics', () => {
  ...
  // ---------------------------------------------------------------------------
  // 7. HUMAN OBSERVER TURN TAKING ROBUSTNESS
  // ---------------------------------------------------------------------------
  describe('7. Human Observer Turn Taking Robustness', () => {
    it('allows turn-taking to continue if there is a human observer but zero active participants', async () => {
      mockGetFirestoreActiveParticipants.mockResolvedValue([
        {
          publicId: 'obs1',
          privateId: 'priv-obs1',
